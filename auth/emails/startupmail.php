            ...
            <table class=\'email-wraper\'>
                ...
                <tr>
                    ...
                    <table class=\'email-body\' border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                        ...
                        <tbody>
                        <tr>
                            <td class=\'pd-3x pdb-1-5x\'><h2 class=\'email-heading\' style="font-family:\'Helvetica\',Helvetica,Arial,sans-serif;color:#151515;font-size:18px;font-weight:700;line-height:34px;letter-spacing:-0.4px;text-align:center">Get started with Iverify&trade;</h2></td>
                        </tr>
                        <tr>
                            <td class=\'pdl-3x pdr-3x pdb-2x\'>
                            <p class=\'mgb-1x\' style="font-family:\'Helvetica\',sans-serif;font-size:14px;line-height:20px;letter-spacing:-0.2px;text-align:center"><b>Dear '. $firstName .' '. $companyName .',</b><br> Please see below step by step guide on how to set up your account.</p>
                            <p class=\'mgb-1x\' style="font-family:\'Helvetica\',sans-serif;font-size:14px;line-height:20px;letter-spacing:-0.2px;text-align:center"><b>Step 1</b><br><a href="https://iverify.ng/auth/login" target="_blank" style="text-decoration: none;">Click here</a> to login using your<br>correct login credentials.</p>
                            <p class=\'mgb-1x\' style="font-family:\'Helvetica\',sans-serif;font-size:14px;line-height:20px;letter-spacing:-0.2px;text-align:center"><b>Step 2</b><br>Top up account using<br>Bank Transfer or Online Payment.</p>
