                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class=\'pdl-3x pdr-3x pdb-2x\'>
                                                        ...
                                                        <p style="text-align:center;padding-bottom:25px;font-family:\'Helvetica\',Helvetica,Arial,sans-serif;font-size:14px;"><a href="http://localhost/web/verify_email?token=' . $token . '"" class=\'btn\' style="color: #ffffff; text-decoration: none;">Verify Account</a></p>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </div>
                                                                ...
                                                                <div style="display:inline-block;vertical-align:top">
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="padding:8px" valign="top" align="center">
                                                                                    <a href=http://localhost/web/verify_email.php?token=' . $token . '" style="text-decoration:none" target="_blank"><img src="https://i.imgur.com/Og7dAzg.png" width="136" height="" alt="Download on Google Play Store" style="border:0;line-height:100%;outline:0;height:auto;font-family:\'Helvetica\',Helvetica,Arial,sans-serif;font-size:14px;color:#ffffff;max-width:100%;display:block"></a>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
