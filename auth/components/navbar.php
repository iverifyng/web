    <header class="bg-white" id=header-main>
        <nav class="navbar navbar-main navbar-expand-lg shadow navbar-light" id=navbar-main>
            <div class=container>
                ...
                <a class="navbar-brand order-lg-1" href=dashboard>
                <img alt="Image placeholder" src=https://i.imgur.com/vdpFo5m.png id=iVerify-logo></a>
                ...
                <ul class="navbar-nav align-items-lg-center d-none d-lg-flex ml-lg-auto">
                    ...
                    <h6 class="dropdown-header px-0 d-lg-flex text-primary">Hi, <?php echo $_SESSION['firstName']; ?> <?php echo $_SESSION['companyName']; ?></h6>
                </ul>
