                                 ...
                                 <td class='pdt-4x pdb-4x'>
                                    ...
                                    <table class='email-body' border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                        <div style='padding-left: 30px;'>
                                            <tbody>
                                                <tr>
                                                    <td class='pd-3x pdb-1-5x'><h2 class='email-heading' style="font-family:'Helvetica',Helvetica,Arial,sans-serif;color:#151515;font-size:18px;font-weight:700;line-height:34px;letter-spacing:-0.4px;text-align:center">Registration Confirmation</h2></td>
                                                </tr>
                                                <tr>
                                                    <td class='pdl-3x pdr-3x pdb-2x'>
                                                        ...
                                                        <p style="text-align:center;padding-bottom:25px;font-family:'Helvetica',Helvetica,Arial,sans-serif;font-size:14px;"><a href="" class='btn' style="color:#ffffff">Confirm Email Address</a></p>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </div>
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td style="font-family:Arial,sans-serif;font-size:19px" valign="top">
                                                                                                        <a href="" style="text-decoration:none" target="_blank"><img src="https://i.imgur.com/zzktAqm.png" width="20" height="20" alt="Facebook" style="border:0;line-height:100%;outline:0;color:#ffffff"></a>
                                                                                                        <span>&nbsp;&nbsp;</span>
                                                                                                        <a href="" style="text-decoration:none" target="_blank"><img src="https://i.imgur.com/Oom7j39.png" width="21" height="18" alt="Twitter" style="border:0;line-height:100%;outline:0;color:#ffffff"></a>
                                                                                                        <span>&nbsp;&nbsp;</span>
                                                                                                        <a href="" style="text-decoration:none" target="_blank"><img src="https://i.imgur.com/gHNAUkh.png" width="21" height="20" alt="" style="border:0;line-height:100%;outline:0;color:#ffffff"></a>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td style="font-family:'Helvetica',sans-serif;font-size:18px;font-weight:500;line-height:24px;letter-spacing:-0.2px" valign="top">
                                                                                                        <a href="tel:08090666746" style="text-decoration:none;color:#f5a522;font-size:14px" target="_blank">08090666746</a>
                                                                                                        <a href="tel:08090666745" style="text-decoration:none;color:#f5a522;font-size:14px" target="_blank">08090666745</a>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="padding:8px" valign="top" align="center">
                                                                                    <a href="" style="text-decoration:none" target="_blank" ><img src="https://i.imgur.com/fuHgMDr.png" width="127" height="" alt="Download on App Store" style="border:0;line-height:100%;outline:0;height:auto;font-family:'Helvetica',Helvetica,Arial,sans-serif;font-size:14px;color:#ffffff;max-width:100%;display:block"></a>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                ...
                                                                <div style="display:inline-block;vertical-align:top">
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="padding:8px" valign="top" align="center">
                                                                                    <a href="" style="text-decoration:none" target="_blank"><img src="https://i.imgur.com/Og7dAzg.png" width="136" height="" alt="Download on Google Play Store" style="border:0;line-height:100%;outline:0;height:auto;font-family:'Helvetica',Helvetica,Arial,sans-serif;font-size:14px;color:#ffffff;max-width:100%;display:block"></a>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
