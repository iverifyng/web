    ...
    <div class=container>
        <div class="row row-grid align-items-center">
            <div class="col-12 col-md-5 col-lg-6 order-md-2">
                <figure class=w-100><img alt="Image placeholder" src=./assets/img/svg/domesticem.gif class="img-fluid mw-md-120"></figure>
            </div>
            <div class="col-12 col-md-7 col-lg-6 order-md-1 pr-md-5">
                <h1 class="display-4 text-center text-md-left mb-3">Domestic Employee <strong class=text-primary>Verification</strong></h1>
                ...
                <ul>
                    ...
                    <li>Previous work address</li>
                    <li>State of origin & LGA confirmation</li>
                    <li>Family background and information</li>
