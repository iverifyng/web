...
?>
    <section class="slice slice-lg bg-cover bg-size--cover" style=background-image:url(https://i.imgur.com/WYAouRL.jpg)><span class="mask bg-primary opacity-9"></span>
                            ...
                            <div class=row>
                                <div class=col>
                                    <div class="input-group input-group-merge shadow-none">
                                        <div class=input-group-prepend><span class="input-group-text bg-transparent border-0"><i data-feather=search></i></span></div><input type=text class="form-control form-control-flush shadow-none" placeholder="Search for answers ..."></div>
                                </div>
                                <div class=col-auto><button type=button class="btn btn-block btn-dark rounded-pill">Search</button></div>
                            </div>
                        </div>
                    </form>
                </div>
                        ...
                        <div class="col-xl-3 col-lg-6 mb-xl-n8">
                            <div class="card hover-translate-y-n10 hover-shadow-lg">
                                <div class="card-body p-5 text-center">
                                    <div class=pb-4><img alt="Image placeholder" src=./assets/img/svg/icons/Code.svg class="svg-inject img-fluid" style=height:40px></div>
                                    <div class=pt-2><a href=# class="h6 stretched-link mb-0">Getting started</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 mb-xl-n8">
                            <div class="card hover-translate-y-n10 hover-shadow-lg">
                                <div class="card-body p-5 text-center">
                                    <div class=pb-4><img alt="Image placeholder" src=./assets/img/svg/icons/Chat.svg class="svg-inject img-fluid" style=height:40px></div>
                                    <div class=pt-2><a href=# class="h6 stretched-link mb-0">Seller questions</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 mb-xl-n8">
                            <div class="card hover-translate-y-n10 hover-shadow-lg">
                                <div class="card-body p-5 text-center">
                                    <div class=pb-4><img alt="Image placeholder" src=./assets/img/svg/icons/Desk.svg class="svg-inject img-fluid" style=height:40px></div>
                                    <div class=pt-2><a href=# class="h6 stretched-link mb-0">Buyer questions</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 mb-xl-n8">
                            <div class="card hover-translate-y-n10 hover-shadow-lg">
                                <div class="card-body p-5 text-center">
                                    <div class=pb-4><img alt="Image placeholder" src=./assets/img/svg/icons/Group.svg class="svg-inject img-fluid" style=height:40px></div>
                                    <div class=pt-2><a href=# class="h6 stretched-link mb-0">Customization</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="shape-container shape-position-bottom"><svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 1000 100" preserveAspectRatio=none><path d="M 0 0 c 0 0 200 50 500 50 s 500 -50 500 -50 v 101 h -1000 v -100 z"></path></svg></div>
    </section>
                        ...
                        <div class=card>
                            <div class="list-group list-group-flush">
                                <a href=#theme-integration data-scroll-to data-scroll-to-offset=50 class="list-group-item list-group-item-action d-flex justify-content-between">
                                    <div><i data-feather=layout class=mr-2></i> <span>Theme integration</span></div>
                                ...
                                <a href=#customization data-scroll-to data-scroll-to-offset=50 class="list-group-item list-group-item-action d-flex justify-content-between">
                                    <div><i data-feather=sliders class=mr-2></i> <span>Customization</span></div>
                                    <div><i data-feather=chevron-right></i></div>
                                </a>
                                <a href=#fonts-and-colors data-scroll-to data-scroll-to-offset=50 class="list-group-item list-group-item-action d-flex justify-content-between">
                                    <div><i data-feather=edit-3 class=mr-2></i> <span>Fonts and colors</span></div>
                                    <div><i data-feather=chevron-right></i></div>
                                </a>
                            </div>
                        </div>
